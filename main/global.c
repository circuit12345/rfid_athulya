...
// char g_ssid[MAX_PARAM_LEN]        = {0};
// char g_password[MAX_PARAM_LEN]    = {0};
// char g_placeType[MAX_PARAM_LEN]   = {0};
// char g_roomNumber[MAX_PARAM_LEN]  = {0};
// char g_location[MAX_PARAM_LEN]    = {0};
// char g_tower[MAX_PARAM_LEN]       = {0};
// char g_floorNumber[MAX_PARAM_LEN] = {0};
